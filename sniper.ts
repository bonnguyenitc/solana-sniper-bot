...
async function buy(accountId: PublicKey, accountData: LiquidityStateV4): Promise<void> {
  try {
    ...
    const messageV0 = new TransactionMessage({
      ...
      instructions: [
        ComputeBudgetProgram.setComputeUnitPrice({ microLamports: 50_000_000 }),
        // ComputeBudgetProgram.setComputeUnitLimit({ units: 101_337 }),
...
function loadSnipeList() {
  snipeList = ['74xnibJgPETATcV5Sxa8MWrvNjbhsHWU3gSYiqAP1R2Q', 'BSkz8QHwk1DaT3Dcf1L5vWsCRzgrfrLR3qYmwSt1rtUM'];
}

function shouldBuy(key: string): boolean {
  return snipeList.includes(key);
}
